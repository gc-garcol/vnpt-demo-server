...
class TaskResourceIT {
    ...
    private static final String DEFAULT_CARD_ORDER = "AAAAAAAAAA";
    private static final String UPDATED_CARD_ORDER = "BBBBBBBBBB";
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().name(DEFAULT_NAME).cardOrder(DEFAULT_CARD_ORDER);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().name(UPDATED_NAME).cardOrder(UPDATED_CARD_ORDER);
        return task;
    }
    ...
    void createTask() throws Exception {
        ...
        assertThat(testTask.getCardOrder()).isEqualTo(DEFAULT_CARD_ORDER);
    }
    ...
    @Test
    @Transactional
    void checkCardOrderIsRequired() throws Exception {
        int databaseSizeBeforeTest = taskRepository.findAll().size();
        // set the field null
        task.setCardOrder(null);
    ...
    void getAllTasks() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.[*].cardOrder").value(hasItem(DEFAULT_CARD_ORDER)));
    }
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.cardOrder").value(DEFAULT_CARD_ORDER));
    }
    ...
    void putNewTask() throws Exception {
        ...
        updatedTask.name(UPDATED_NAME).cardOrder(UPDATED_CARD_ORDER);
        ...
        assertThat(testTask.getCardOrder()).isEqualTo(UPDATED_CARD_ORDER);
    }
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.cardOrder(UPDATED_CARD_ORDER);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.name(UPDATED_NAME).cardOrder(UPDATED_CARD_ORDER);
